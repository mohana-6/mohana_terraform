...
target_group_arn_nlb   = "arn:aws:elasticloadbalancing:us-east-1:324936657337:targetgroup/vector-star-nlb-tg/58f0752c4693290c"
attach_to_lb = true
container_port         =  8688
min_capacity           = 1
max_capacity           = 1
...
environment = {
  "VECTOR_LOG" = "debug"
  "VECTOR_CONFIG_BUCKET_URL" = "s3://errorbudget-s3/vector_config_dev/vector_star.yaml"
